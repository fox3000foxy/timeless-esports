    ...
    <section id="history" className="history-section">
      <div className="container">
        ...
        <p className="section-subtitle">
          Une équipe née d'un rêve commun : prouver que la persévérance, la
          solidarité et le talent n'ont pas d'origine.
        </p>
        ...
        <div className="history-grid">
          <div className="history-main">
            ...
            <p className="history-description">
              <strong>Timelesss</strong> est née d'un rêve partagé : prouver que
              la passion et la persévérance peuvent traverser les frontières. À
              l'origine du projet, <strong>Emi Tanaka</strong>, une jeune
              franco-japonaise installée en Normandie, décide de créer une
              équipe à son image : humaine, ambitieuse et unie.
            </p>
            ...
            <p className="history-description">
              Fondée en <strong>août 2025</strong>, <strong>Timeless</strong>{" "}
              s'est construite sur la conviction que le talent ne se limite ni à
              une origine, ni à un parcours. Chacun de ses membres a dû
              surmonter ses propres épreuves - solitude, précarité, perte ou
              doute - et a transformé ces obstacles en force collective.
            </p>
            ...
            <p className="history-description">
              Au-delà du jeu, Timeless défend des valeurs fortes -{" "}
              <strong>justice</strong>, <strong>passion</strong> et{" "}
              <strong>persévérance</strong> - et aspire à inspirer une
              communauté authentique, soudée et ambitieuse.
            </p>
          </div>
