...
export const teamMembersData: TeamMember[] = [
  {
    ...
    nickname: "Emster",
    achievements: [
      "Top 5 Regional Controller",
      "Team MVP March 2024",
      "Best Map Control 2024",
    ],
  ...
  },
  {
    ...
    nickname: "Colomb",
    achievements: [
      "Best Sentinel in Local League",
      "Clutch Queen Award",
      "Defensive Maestro 2024",
    ],
  ...
  },
  {
    ...
    fullStory: `Emi est née dans les rues animées de Shibuya où elle a grandi fascinée par la technologie et la compétition. À 14 ans, elle a participé à un tournoi Valorant local et a immédiatement su que c'était sa destinée. Son charisme naturel et son instinct stratégique l'ont rapidement propulsée au-dessus de la concurrence. Elle voit le jeu comme une danse, chaque movement de Jett comme une chorégraphie parfaitement orchestrée. Fondatrice de facto de Timeless, elle incarne l'esprit d'innovation et de leadership du groupe.`,
  ...
  },
  {
    ...
    nickname: "Phantom",
    achievements: [
      "Top Initiator in Weekly Scrims",
      "Utility Master Award",
      "Best Recon Player",
    ],
  ...
  },
  {
    ...
    nickname: "Panther",
    achievements: [
      "Top Fragger in Local Matches",
      "Flashiest Play Award",
      "Most Aggressive Duelist",
    ],
    instagram:
      "https://www.instagram.com/rami_vemuri?igsh=MWYxYXlwbG9mYjhuOQ%3D%3D&utm_source=qr", // Ajout du lien Instagram
  },
];
