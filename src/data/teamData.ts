...
export const teamMembersData: TeamMember[] = [
    ...
    },
    {
        ...
        fullStory: `Rami vient de Bangalore, une terre d'innovation mais pas nécessairement reconnue pour l'esport compétitif. Ses parents rêvaient pour lui d'une carrière d'ingénieur, mais son cœur battait pour le gaming. Il a commencé sur des cybercafés locaux, progressant silencieusement à travers les rangs en ligne. Son mécanique de jeu est explosive et non conventionnelle, reflétant son caractère audacieux. Il a trouvé en Phoenix l'agent qui correspondait à son style agressif et impétueux. Son admission à Timeless Esports est un triomphe personnel, prouvant que le talent brille indépendamment de la géographie.`,
